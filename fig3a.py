...
# file parameters
INFLUENCE_FILE = 'Fig3a/influence.csv'
INITIAL_OPINIONS = 'Fig3a/t0.csv'
RESULT_OPINION_PROGRESSION = 'Fig3a/opinion_progression.csv'
RESULT_CONF_PROGRESSION = 'Fig3a/conf_progression.csv'
IMG_PATH = 'Fig3a/opinion_progression.svg'
